      ...
      <ReadmeCard>
        <div className="flex flex-col space-y-4 text-left justify-center">
          ...
          <ul className="list-disc pl-6">
            <li>
              <span className="text-link">cd</span>: changes directory. Use this
              to navigate between pages. <span className="font-bold">cd</span>{" "}
              followed up by the{" "}
              <span className="font-bold">desired page name </span> to navigate
              to the next page. cd followed up by{" "}
              <span className="font-bold"> ..</span> to back and{" "}
              <span className="font-bold">cd</span> (without other command) will
            ...
            <li>
              <span className="text-link">ls</span>: lists all available pages.
            </li>
            <li>
